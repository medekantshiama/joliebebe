...
with open('result.zip/product_characteristics.csv','w', encoding='utf-8') as first_file:
    ...
    for i, cat in enumerate(getCategory(2)[2:53]):
        ...
        for url, name in zip(getImageUrl(), getName()):
            ...
            image_name = 'C:/Users/Random/PycharmProjects/pythonProject2/joliebebe-scrape1/result.zip/image_result/' + good_name + '.jpg'
